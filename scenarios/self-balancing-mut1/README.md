...
---
This is a edited scenario for using in the master thesis. It is based on the mt-image, but has mutated controller in the selfbalancing approach.

Mutation test case:
Mutations generated by [universalmutator](https://github.com/agroce/universalmutator). This is the mutation scenario 1 which will be used in the case study for the master thesis.
---
